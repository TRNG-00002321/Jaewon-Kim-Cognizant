...
public class DynamicVisualTest {
    ...
    void testWithHiddenDynamicElements() throws Exception {
        ...
        Path path = Paths.get("target/visual-baselines/dynamic-hidden.png");
    ...
    void testWithMaskedRegions() throws Exception {
        ...
        Path path = Paths.get("target/visual-baselines/header-only.png");
        Files.createDirectories(path.getParent());
        Files.write(path, screenshot);
    }
    ...
    void testWithDateReplacement() throws Exception {
        ...
        Path path = Paths.get("target/visual-baselines/static-dates.png");
        Files.createDirectories(path.getParent());
        Files.write(path, screenshot);
    }
    ...
    void testWaitForAnimationsComplete() throws Exception {
        ...
        Path path = Paths.get("target/visual-baselines/post-animation.png");
        Files.createDirectories(path.getParent());
        Files.write(path, screenshot);
    }
    ...
    void testResponsiveVisuals() throws Exception {
        ...
        for (int i = 0; i < viewports.length; i++) {
            ...
            Path path = Paths.get("target/visual-baselines/responsive-" + viewports[i] + ".png");
            Files.createDirectories(path.getParent());
            Files.write(path, screenshot);
